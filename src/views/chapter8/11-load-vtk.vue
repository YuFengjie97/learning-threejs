...
import modelUrl from '@/assets/models/moai_fixed.vtk?url'
...
async function initMesh() {
  ...
  modelGeo.applyMatrix4(new THREE.Matrix4().makeTranslation(0,1,0))

  const mat1 = new THREE.MeshLambertMaterial({color: 0xa29bfe})
