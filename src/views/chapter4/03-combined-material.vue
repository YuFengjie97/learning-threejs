...
/**
 * 混合材质，混合depth与basic材质，
 * 这样既可以自定义颜色，又可以根据相机距离，控制灰度
 * basic材质需要设置transparent与blending模式，
 * 其中blending设置为多重混合
 */
...
let depthMat: THREE.MeshDepthMaterial = new THREE.MeshDepthMaterial()
let basicMat: THREE.MeshBasicMaterial = new THREE.MeshBasicMaterial({
  color: 0x0984e3,
  transparent: true,
...
const cubeParams = {
  ...
  addCube: function () {
    ...
    const cube = createMultiMaterialObject(cubeGeo, [depthMat, basicMat])
